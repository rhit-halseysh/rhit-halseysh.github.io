...
Sub saveData(inp As String)
    ...
    mapper.add "ahu", "autoHighCube"
    mapper.add "aho", "autoHighCone"
    mapper.add "amu", "autoMidCube"
    mapper.add "amo", "autoMidCone"
    mapper.add "alu", "autoLowCube"
    mapper.add "alo", "autoLowCone"
    ...
    mapper.add "thu", "teleopHighCube"
    mapper.add "tho", "teleopHighCone"
    mapper.add "tmu", "teleopMidCube"
    mapper.add "tmo", "teleopMidCone"
    mapper.add "tlu", "teleopLowCube"
    mapper.add "tlo", "teleopLowCone"
    
    'Endgame
    mapper.add "ds", "driverSkill"
    mapper.add "ls", "linksScored"
    mapper.add "dr", "defensePlayed"
